...
abstract class  ustredny_Pokorny_Jakub{
     ...
     * pri cteni to samé
 */
    public function setNapeti_Pokorny_Jakub(float $napeti_Pokorny_Jakub) : float{
        $this->napeti_Pokorny_Jakub = $napeti_Pokorny_Jakub;
    }
    //precteni napeti
    public function getNapeti_Pokorny_Jakub() : float {
...
//pres vardummp vypise hodnotu v type a hodnotu napeti na ustredne
 ...
 var_dump (ustredna_Pokorny_Jakub::Napeti_Pokorny_Jakub);
?> 